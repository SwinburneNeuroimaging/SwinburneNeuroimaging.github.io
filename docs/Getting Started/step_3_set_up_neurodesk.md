...
1. Follow the complete setup instructions at the [Neurodesk NECTAR guide](https://www.neurodesk.org/docs/neurodesktop/getting-started/nectar/). This process can take approximetly 10 minutes to set up. Use **3209** for "First Field of Research Code" and **4003** for "Optional Second Field of Research Code"
