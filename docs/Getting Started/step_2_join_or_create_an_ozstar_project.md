# Step 2 - Join or Create an OzSTAR Project
...
Once you've completed steps 1 and 2, you're ready to move on to [Set up Neurodesk](/Getting Started/step_3_set_up_neurodesk). 
