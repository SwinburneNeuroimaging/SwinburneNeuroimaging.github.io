...
Refer to [https://surfer.nmr.mgh.harvard.edu/fswiki/ReconAllOutputFiles](https://surfer.nmr.mgh.harvard.edu/fswiki/ReconAllOutputFiles)

## How to locate the T1 that was used for the parcellation?

Freesurfer saves the original T1 input file in 
```
FREESURFER_BASE_DIR/PARTICIPANT_DIR/mri/orig/001.mgz
```
